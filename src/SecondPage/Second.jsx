  ...
  return (
    <div style={{ textAlign: 'center', padding: '20px', margin: '20px' }}>
      ...
      >
        ...
        <SwiperSlide style={{borderRadius: '15px', backgroundColor: 'var(--Black-100, #E6E6E6)'}}><img src="/images/image 66.png" width={150} alt="Brand 8" /></SwiperSlide>
        <SwiperSlide style={{borderRadius: '15px', backgroundColor: 'var(--Black-100, #E6E6E6)'}}><img src="/images/image 67.png" width={150} alt="Brand 7" /></SwiperSlide>
        <SwiperSlide style={{borderRadius: '15px', backgroundColor: 'var(--Black-100, #E6E6E6)'}}><img src="/images/image 57.png" width={150} alt="Brand 7" /></SwiperSlide>
        <SwiperSlide style={{borderRadius: '15px', backgroundColor: 'var(--Black-100, #E6E6E6)'}}><img src="/images/image 47.png" width={150} alt="Brand 7" /></SwiperSlide>
      </Swiper>
    </div>
  );
};
